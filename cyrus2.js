	...
	async generateText(user, host, env) {
		...
		ips.forEach((ip) => {
			ports.forEach((portStr) => {
				...
				const remark = (links.length === 1) ? "یه پینگ کلی بگیر وصل شو به پر سرعت ترین ☕️" : "@CFsazbot";
